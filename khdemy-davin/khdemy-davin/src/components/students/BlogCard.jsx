...
export default function BlogCard({ b, isSaved, onToggleSave, onClick }) {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <div className="w-[24px] h-[24px] sm:w-[26px] sm:h-[26px] rounded-full overflow-hidden flex-shrink-0 bg-gradient-to-br from-indigo-500 to-purple-500">
              <img
                src={b.authorImg || "/profilenew.PNG"}
                alt={author}
          ...
          <div className="flex items-center gap-1.5">
            ...
            {onToggleSave && (
              <button
                onClick={e => { e.preventDefault(); e.stopPropagation(); onToggleSave(b) }}
